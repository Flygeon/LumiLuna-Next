...
export const messages = {
  zh: {
    ...
    player: {
      ...
      lyricReason_missingInfo: "缺少歌曲标题或时长",
      lyricReason_searchFailed: "QQ 搜索失败（网络或接口异常）",
      lyricReason_noMatch: "未找到同名且时长差不超过 1 秒的歌曲",
      lyricReason_noLyrics: "找到候选但未能获取歌词",
    },
    library: {
      empty: "暂无媒体，请先扫描目录",
      scanning: "正在扫描…",
  ...
  en: {
    ...
    player: {
      ...
      lyricReason_missingInfo: "missing song title or duration",
      lyricReason_searchFailed: "QQ search failed (network or API error)",
      lyricReason_noMatch: "no song with the same title and duration within ±1s",
      lyricReason_noLyrics: "candidates found but no usable lyrics",
    },
    library: {
